    ...
    zh: {
      system: [
        {
          ...
          bullets: [
            '此系統為企業內部使用之車隊即時監控平台，提供車輛位置追蹤、狀態監控與行為視覺化分析，協助即時掌握車隊運行狀況。',
        ...
        },
        {
          ...
          bullets: [
            '以KW Map（勤崴地圖）作為基礎底圖平台，提供管理端更完整的地圖監控與資料分析，協助進行高效率的車隊管理。',
            '負責前端整體開發與模組拆分，建立可維護的系統架構。',
            '使用Angular 20 + TypeScript開發主要功能，確保大型系統的穩定性與可擴充性。',
            '整合KW Map建構地圖監控功能。',
        ...
        },
        {
          ...
          bullets: [
            ...
            '實作個人化設定匯入/匯出功能，將圖層顯示與欄位設定轉為JSON檔案，方便使用。',
      ...
      showcase: [
        ...
        },
        {
          ...
          subtitle: '產品展示網站',
          bullets: [
            '此專案為產品形象展示網站，主要用於呈現品牌產品特色、視覺質感與科技感。網站以深色系視覺作為主，搭配產品大圖與簡潔的資訊排版，強化產品的高階形象與專業感，讓使用者能快速理解產品亮點。',
            '負責產品網站版面規劃與前端切版。',
            '依照產品特色設計深色系視覺風格。',
            '規劃首頁主視覺、產品介紹與資訊層級。',
